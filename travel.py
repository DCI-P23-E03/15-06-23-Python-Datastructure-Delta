...
print("""
Hello! Welcome to Travel Destination Recommendation System\n
...
if choose_country not in database:
    print(f"We are sorry, the country of your choice {choose_country} is not in our database")
input()

x('clear')    
add_a_country=input('Enter a country to add to our database:')
       
database[add_a_country] = {} 
